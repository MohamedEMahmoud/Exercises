...
import { validateRequest, BadRequestError, validateImage, upload, GenderType, PictureType, RoleType } from "@jogging/common";
...
router.post("/api/auth/signup",
    ...
    async (req: Request, res: Response) => {
        ...
        if (!req.body.coachName && req.body.role === RoleType.Coach) {
            throw new BadRequestError("coach name must be defined");
        }
        ...
        if (req.body.coachName && req.body.role === RoleType.Trainee) {
            const coach = await User.findOne({ coachName: req.body.coachName });
            if (!coach) {
                throw new BadRequestError("coach is not exist");
            }
        ...
        if (files.picture) {
            await new Promise((resolve, reject) => {
                Cloudinary.uploader.upload_stream({
                    public_id: `profile-picture/jogging-${user.username}`,
                    use_filename: true,
                        ...
                        <div style="text-align: center;  font-family: sans-serif">
                            ...
                            <div style="text-align: center; margin: auto; padding: 20px; background: #FFFFFF; color: #041438">
                                ...
                                <p style="font-size: 16px">
                                 activate your Jogging-Microservices account 
                                </p>
                            ...
                            <div style="margin: 20px; background: transparent; color: #041438">
                                ...
                                <p style="margin: 20px 0; direction: ltr">&copy; 2022 - <a style="color: #041438; direction: ltr" href="mailto:techno@beta.ai">Jogging-Microservices Technical Team</a>, All rights reserved</p>
                          </div>
                    `,
        };
